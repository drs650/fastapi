...
# starlette : FastAPI가 내부적으로 사용하는 ASGI프레임워크
from starlette import status  # status : HTTP
...
# Depends --> FastAPI의 의존성 주입 기능
#       이 엔드포인트가 실행되기 전에, 이 함수부터 먼저 실행해서 결과를 파라미터에 넣어줘.
