...
token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxMCwiZXhwIjoxNzg2MzQwOTU1fQ.wUOqSQCRt4fhf5bHfcRF0fDVt8ri6Br-WzkaAgI1A_w'
...
def decode(b64: str):
    ...
    return json.loads(decoded)  # 디코딩한 바이트를 JSON(dict)로 변환
